...
renderer = animation.Renderer(conf, manager)
...
renderer.render_animation(renderer.compose_state('idle') + renderer.compose_state('joy') + renderer.compose_state('disgust') + renderer.compose_state('idle'), debugging=True)